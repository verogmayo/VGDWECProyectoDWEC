...
function guardarTiempoJuego(nombre, tiempoJuego,nivelActual) {
    ...
    // Si el nivel no existe, crear un array vacío
    if (!tiemposNivel) {
        tiemposNivel = [];
        datosPuntuacion[nivelActual] = tiemposNivel;
    }
...
console.log("Datos disponibles:", datosPuntuacion);
    ...
    // Si el nivel no existe, crear un array vacío
    if (!datosPuntuacion[nivelActual]) {
        datosPuntuacion[nivelActual] = [];
    }
...
function mostrarPosicion(nivelActual) {
  ...
  console.log(" MostrarPosicion: tabla con los datos del nivel:", tiemposNivel);
    ...
    // Si el nivel no existe en el objeto, crear un array vacío
    if (!tiemposNivel) {
        tiemposNivel = [];
        datosPuntuacion[nivelActual] = tiemposNivel;
    }
